import"./assets/footer-mascot-DQU0rhVr.js";const y=document.getElementById("message-container");let l="All Categories",c=null;function m(){const r=localStorage.getItem("favArr");let t=[];try{t=r?JSON.parse(r):[]}catch(a){console.error("Error parsing favArr from localStorage:",a),t=[]}const e=document.querySelector(".favorite-cards");return e&&(e.innerHTML=""),t.length===0&&(y.innerHTML=`
